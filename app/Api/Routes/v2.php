...
use App\Api\V2\Http\Controllers\Environment\ApproveEnvironmentVariablePromotionRequest;
use App\Api\V2\Http\Controllers\Environment\CancelEnvironmentVariablePromotionRequest;
...
use App\Api\V2\Http\Controllers\Environment\CreateEnvironmentVariableComment;
use App\Api\V2\Http\Controllers\Environment\CreateEnvironmentVariablePromotionRequest;
...
use App\Api\V2\Http\Controllers\Environment\DeleteEnvironmentVariableComment;
...
use App\Api\V2\Http\Controllers\Environment\GetEnvironmentVariableContext;
...
use App\Api\V2\Http\Controllers\Environment\GetEnvironmentVariablePromotionRequests;
use App\Api\V2\Http\Controllers\Environment\PreviewEnvironmentVariablePromotionRequest;
use App\Api\V2\Http\Controllers\Environment\PullEnvironment;
use App\Api\V2\Http\Controllers\Environment\PushEnvironment;
use App\Api\V2\Http\Controllers\Environment\RejectEnvironmentVariablePromotionRequest;
use App\Api\V2\Http\Controllers\Environment\RollbackEnvironmentVariable;
use App\Api\V2\Http\Controllers\Environment\ShowEnvironmentVariablePromotionRequest;
...
use App\Api\V2\Http\Controllers\Environment\UpdateEnvironmentVariableNote;
use App\Api\V2\Http\Controllers\Organization\CreateOrganization;
use App\Api\V2\Http\Controllers\Organization\CreateOrganizationAuditWebhook;
...
use App\Api\V2\Http\Controllers\Organization\GetOrganizationInbox;
use App\Api\V2\Http\Controllers\Organization\GetOrganizationInboxUnreadCount;
...
use App\Api\V2\Http\Controllers\Organization\GetOrganizationPermissionMatrix;
...
use App\Api\V2\Http\Controllers\Organization\ListOrganizationAuditWebhooks;
use App\Api\V2\Http\Controllers\Organization\MarkOrganizationInboxNotificationRead;
use App\Api\V2\Http\Controllers\Organization\MarkOrganizationInboxNotificationsRead;
use App\Api\V2\Http\Controllers\Organization\RotateOrganizationAuditWebhookSecret;
use App\Api\V2\Http\Controllers\Organization\ShowOrganizationKeyReshareRequest;
use App\Api\V2\Http\Controllers\Organization\TestOrganizationAuditWebhook;
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('organizations')->group(function () {
            ...
            Route::prefix('{organization}/audit-webhooks')->group(function () {
                ...
                Route::post('{auditWebhook}/test', TestOrganizationAuditWebhook::class);
            });
            Route::get('{organization}/key-reshare-requests', GetOrganizationKeyReshareRequests::class);
            Route::get('{organization}/key-reshare-requests/{requestId}', ShowOrganizationKeyReshareRequest::class);
            ...
            Route::middleware(TrackUsage::class)->group(function () {
                ...
                Route::get('{organization}/notifications/inbox', GetOrganizationInbox::class);
                Route::get('{organization}/notifications/inbox/unread-count', GetOrganizationInboxUnreadCount::class);
                Route::post('{organization}/notifications/inbox/read', MarkOrganizationInboxNotificationsRead::class);
                Route::post('{organization}/notifications/inbox/{notification}/read', MarkOrganizationInboxNotificationRead::class);
            });
        });
        ...
        Route::prefix('projects/{project}')->group(function () {
            ...
            Route::middleware(TrackUsage::class)->group(function () {
                ...
                Route::prefix('environments/{name}')->group(function () {
                    ...
                    Route::get('variables/{variable}/context', GetEnvironmentVariableContext::class);
                    Route::put('variables/{variable}/context/note', UpdateEnvironmentVariableNote::class);
                    Route::post('variables/{variable}/context/comments', CreateEnvironmentVariableComment::class);
                    Route::delete('variables/{variable}/context/comments/{comment}', DeleteEnvironmentVariableComment::class);
                    ...
                    Route::post('promotion-requests/preview', PreviewEnvironmentVariablePromotionRequest::class);
                    Route::post('promotion-requests', CreateEnvironmentVariablePromotionRequest::class);
                    Route::get('promotion-requests', GetEnvironmentVariablePromotionRequests::class);
                    Route::get('promotion-requests/{promotionRequest}', ShowEnvironmentVariablePromotionRequest::class);
                    Route::post('promotion-requests/{promotionRequest}/approve', ApproveEnvironmentVariablePromotionRequest::class);
                    Route::post('promotion-requests/{promotionRequest}/reject', RejectEnvironmentVariablePromotionRequest::class);
                    Route::post('promotion-requests/{promotionRequest}/cancel', CancelEnvironmentVariablePromotionRequest::class);
