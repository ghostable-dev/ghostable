...
final class GetOrganizationActivity extends Controller
{
    ...
    {
        $this->authorize('viewAuditLogs', $organization);
        ...
        $paginator = Activity::forOrganization($organization)
            ->with(['causer', 'subject'])
    ...
    private function presentSubject(Activity $activity): array
    {
        ...
        $type = match (true) {
            $subject instanceof Organization => 'organization',
