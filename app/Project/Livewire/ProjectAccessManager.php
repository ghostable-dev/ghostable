...
class ProjectAccessManager extends Component
{
    ...
    {
        $this->authorize('admin', $project->team);
    ...
    {
        $this->authorize('admin', $this->project->team);
    ...
    public function members(): Collection
    {
        return $this->project->team->users
            ->reject(fn (User $user) => $this->project->team->hasRole($user, 'admin'));
    }
    ...
    public function confirmOverrideRemoval(TeamPermissionOverride $override): void
    {
        ...
        $this->authorize('admin', $this->overrideToRemove->target->team);
