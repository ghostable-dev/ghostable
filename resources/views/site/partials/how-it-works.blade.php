  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="max-w-2xl mx-auto text-left lg:text-center">
      ...
      <flux:subheading size="xl" class="mt-4">
        Push your .env, define rules, invite your organization—and let Ghostable handle the rest.
      </flux:subheading>
    </div>
    ...
    <div class="mt-16 max-w-2xl mx-auto border-l border-white/10 space-y-12 pl-6">
      ...
      <div class="relative">
        <div class="absolute -left-3 top-1.5 h-2.5 w-2.5 rounded-full bg-teal-400"></div>
        <div>
          <flux:heading level="3" class="text-white">3. Invite your organization or CI</flux:heading>
          <p class="mt-2 text-sm text-gray-400">
            Share access by project, environment, or organization—fine-tuned with role-based permissions.
          </p>
        </div>
      </div>
