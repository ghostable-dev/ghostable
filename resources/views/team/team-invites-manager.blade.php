<div>
    ...
    <flux:modal variant="bare" name="send-invite" class="min-w-[22rem]">
        <x-modal.form wire:submit="sendInvite">
            ...
            <x-slot:description>
                <p class="text-wrap">You're about to remove the invite sent to. Please select the appropriate role and enter the email of the person you’d like to invite to your team.</p>
            </x-slot:description>
            <div class="space-y-6 mb-4">
                <flux:input type="email" label="Email" required wire:model="email"/>
                <x-team-role-select wire:model="role"/>
            </div>
            <x-slot:actions>
