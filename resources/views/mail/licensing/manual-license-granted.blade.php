...
@section('content')
    ...
    <x-mail.simple.title>Your Ghostable license</x-mail.simple.title>

    <x-mail.simple.paragraph>
        A Ghostable license has been generated for <strong>{{ $organization_name }}</strong>.
    </x-mail.simple.paragraph>
    ...
    <x-mail.simple.button href="{{ $login_url }}">Open Ghostable</x-mail.simple.button>

    <x-mail.simple.paragraph>
        Use this key in the Ghostable desktop app when activating your license.
    </x-mail.simple.paragraph>

    <x-mail.simple.paragraph>
        If you were not expecting this license, you can ignore this email.
    </x-mail.simple.paragraph>
