  ...
  ignores:
    ...
    <x-docs.section id="fields" title="Manifest fields">
        <x-docs.command-table :commands="[
            ...
            ['command' => 'activity.mode', 'description' => 'Records the requested activity detail level: off, minimal, or full. Required signed security and mutation events are still written in v3; do not use off as an audit-disable control.'],
            ['command' => 'activity.auditEnvironments', 'description' => 'Default environment scope used by review and hygiene when --env is omitted; defaults to production and staging when those environments exist.'],
